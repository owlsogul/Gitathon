...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0012_auto_20181030_0633'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='member',
            name='registerDate',
            field=models.DateTimeField(default=datetime.datetime(2018, 10, 29, 21, 34, 33, 787736, tzinfo=utc), verbose_name='date registered'),
        ),
        migrations.AlterField(
