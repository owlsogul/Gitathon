...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0011_auto_20181030_0631'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='member',
            name='registerDate',
            field=models.DateTimeField(default=datetime.datetime(2018, 10, 29, 21, 33, 58, 490950, tzinfo=utc), verbose_name='date registered'),
        ),
        migrations.AlterField(
