    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2018, 11, 19, 14, 58, 22, 839596, tzinfo=utc))),
        ...
        migrations.CreateModel(
            name='HackUsability',
            fields=[
                ('usability', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('hackId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hackathon.HackathonInformation')),
                ('teamContriId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='teamproject.TeamContribution')),
            ],
        ),
    ]
